...
import AppDialog, { AppDialogProps } from "@/components/common/app-dialog";
...
export default function SignUpPage() {
  ...
  const [dialogConfig, setDialogConfig] = useState<AppDialogProps>({
    title: "",
    message: "",
  ...
  return (
    <div className="mx-auto min-h-[80dvh] min-w-[400px] flex-col items-center justify-center py-24">
      ...
      <AppDialog open={isDialogOpen} onOpenChange={setIsDialogOpen} {...dialogConfig} />
    </div>
  );
}
